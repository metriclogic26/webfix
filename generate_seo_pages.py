#!/usr/bin/env python3
"""Generate SEO content pages for stackfix.dev. Run from repo root: python3 generate_seo_pages.py"""
...
<head>
  ...
  <link rel="canonical" href="https://stackfix.dev{canonical}">
  <meta name="robots" content="index, follow">
  <meta name="author" content="MetricLogic">
  <meta property="og:title" content="{title}">
  <meta property="og:description" content="{description}">
  <meta property="og:url" content="https://stackfix.dev{canonical}">
...
<body>
  <nav>
    <a href="/" class="brand">StackFix <span>/</span> {nav_section}</a>
    <div class="right">
  ...
  <footer>
    <span>StackFix by MetricLogic · <a href="https://configclarity.dev">configclarity.dev</a> · <a href="https://domainpreflight.dev">domainpreflight.dev</a> · <a href="https://packagefix.dev">packagefix.dev</a></span>
    <span>MIT · <a href="https://github.com/metriclogic26/stackfix">GitHub →</a></span>
  </footer>
</body>
</html>'''
...
def main() -> None:
    ...
    def tech_article(
        ...
        return {
            ...
            "headline": headline,
            "description": description,
            "url": f"https://stackfix.dev{url_path}",
    ...
    FIX = [
        (
            "headers",
            "nginx",
            "Fix Missing Security Headers on Nginx — StackFix",
        ...
        (
            "headers",
            "apache",
            "Fix Missing Security Headers on Apache — StackFix",
        ...
        (
            "headers",
            "cloudflare",
            "Fix Missing Security Headers on Cloudflare — StackFix",
        ...
        (
            "headers",
            "vercel",
            "Fix Missing Security Headers on Vercel — StackFix",
        ...
        (
            "headers",
            "netlify",
            "Fix Missing Security Headers on Netlify — StackFix",
        ...
        (
            "headers",
            "express",
            "Fix Missing Security Headers on Express — StackFix",
        ...
        (
            "headers",
            "sharepoint",
            "Fix SharePoint CSP 'Refused to Load' — 2026 Enforcement — StackFix",
        ...
        (
            "cors",
            "nginx",
            "Fix CORS Errors on Nginx — StackFix",
        ...
        (
            "cors",
            "express",
            "Fix CORS Errors on Express — StackFix",
        ...
        (
            "cors",
            "fastapi",
            "Fix CORS Errors on FastAPI — StackFix",
        ...
        (
            "cors",
            "django",
            "Fix CORS Errors on Django — StackFix",
        ...
        (
            "cors",
            "nextjs",
            "Fix CORS Errors on Next.js — StackFix",
        ...
        (
            "cors",
            "flask",
            "Fix CORS Errors on Flask — StackFix",
        ...
        (
            "csp",
            "nginx",
            "Fix Content Security Policy on Nginx — StackFix",
        ...
        (
            "csp",
            "cloudflare",
            "Fix Content Security Policy on Cloudflare — StackFix",
        ...
        (
            "csp",
            "vercel",
            "Fix Content Security Policy on Vercel — StackFix",
        ...
        (
            "csp",
            "sharepoint",
            "Fix SharePoint Content Security Policy — 2026 — StackFix",
        ...
        (
            "oauth",
            "auth0",
            "Fix OAuth Errors on Auth0 — PKCE, redirect_uri, invalid_grant — StackFix",
        ...
        (
            "oauth",
            "okta",
            "Fix OAuth Errors on Okta — StackFix",
        ...
        (
            "oauth",
            "cognito",
            "Fix OAuth Errors on AWS Cognito — StackFix",
        ...
        (
            "oauth",
            "google",
            "Fix OAuth Errors on Google — StackFix",
        ...
        (
            "cache",
            "nginx",
            "Fix Cache-Control Headers on Nginx — StackFix",
        ...
        (
            "cache",
            "cloudflare",
            "Fix Cache-Control Headers on Cloudflare — StackFix",
        ...
        (
            "cache",
            "vercel",
            "Fix Cache-Control Headers on Vercel — StackFix",
        ...
        (
            "pagespeed",
            "nginx",
            "Fix PageSpeed Score on Nginx — StackFix",
        ...
        (
            "pagespeed",
            "cloudflare",
            "Fix PageSpeed Score on Cloudflare — StackFix",
        ...
        (
            "pagespeed",
            "vercel",
            "Fix PageSpeed Score on Vercel — StackFix",
        ...
        (
            "pagespeed",
            "wordpress",
            "Fix PageSpeed Score on WordPress — StackFix",
    ...
    for cat, slug, title, description, content, tool_url, cta, canonical in FIX:
        ...
        headline = title.replace(" — StackFix", "")
        graph = [
    ...
    for cat in ["headers", "cors", "csp", "oauth", "cache", "pagespeed"]:
        ...
        for _, s, title, *_ in [f for f in FIX if f[0] == cat]:
            href = f"/fix/{cat}/{s}/"
            links_html += f"<li><a href='{href}'>{title.replace(' — StackFix', '')}</a></li>"
        links_html += "</ul>"
        canonical = f"/fix/{cat}/"
        dirs_set.add(f"fix/{cat}")
        name = f"{cat.capitalize()} fixes"
        graph = [
            collection_ld(name + " — StackFix", canonical + "/", f"Index of StackFix {cat} configuration guides."),
            *breadcrumb_items_to_graph([("StackFix", "/"), ("Fix", "/fix/"), (name, "")]),
        ]
        p = write_page(
            "fix",
            cat,
            title=f"{name} — StackFix",
            description=f"All StackFix guides for fixing {cat} issues across stacks.",
            canonical=canonical + "/",
            nav_section="Fix",
            breadcrumb=bc_html([("StackFix", "/"), ("Fix", "/fix/"), (name, None)]),
            h1=name,
            content=f"<p>Step-by-step fixes for {cat} on the stacks below. Each page links to the matching StackFix tool for live diagnostics.</p>{links_html}",
    ...
    ERR = [
        (
            "cors-blocked",
            "CORS Error: Access Blocked — StackFix",
        ...
        (
            "csp-refused-to-load",
            "CSP: Refused to Load Script — StackFix",
        ...
        (
            "invalid-grant",
            "OAuth Error: invalid_grant — StackFix",
        ...
        (
            ...
            "OAuth Error: redirect_uri_mismatch — StackFix",
        ...
        (
            "pkce-required",
            "OAuth Error: PKCE Required — StackFix",
        ...
        (
            ...
            "Security: Authenticated Response Cached — StackFix",
        ...
        (
            ...
            "X-Frame-Options Missing — StackFix",
        ...
        (
            ...
            "PageSpeed: Render-Blocking Resources — StackFix",
        ...
        (
            ...
            "PageSpeed: Inefficient Cache Policy — StackFix",
        ...
        (
            ...
            "PageSpeed: Enable Text Compression — StackFix",
    ...
    for slug, title, description, content, tool_url, cta, canonical in ERR:
        ...
        graph.extend(
            breadcrumb_items_to_graph(
                [("StackFix", "/"), ("Errors", "/error/"), (headline, "")]
            )
        )
        p = write_page(
            "error",
            ...
            canonical=canonical.rstrip("/") + "/",
            nav_section="Errors",
            breadcrumb=bc_html([("StackFix", "/"), ("Errors", "/error/"), (headline, None)]),
            h1=headline,
            content=content,
            tool_url=tool_url,
            tool_cta_text=cta,
    ...
    PROV = [
        ...
        (
            "apache",
            "Apache Security & Performance Fixes — StackFix",
            "httpd modules for headers, compression, and CSP on Apache.",
            '<p>Apache deployments rely on <code>mod_headers</code>, <code>mod_rewrite</code>, and sometimes <code>mod_security</code>. StackFix documents <a href="/fix/headers/apache/">security headers</a> and connects to CORS patterns when you proxy to a backend.</p><p>Because .htaccess and VirtualHost differ per host, live scans prevent guessing which directives apply. SpeedFixer still helps when Apache serves static build output behind TLS termination.</p><p>Compare <a href="/providers/nginx/">Nginx hub</a> for the same categories.</p>',
            "/headers/",
            "Open HeadersFixer →",
            "/providers/apache/",
        ),
        (
            "cloudflare",
            "Cloudflare Security & Performance Fixes — StackFix",
        ...
        (
            "vercel",
            "Vercel Security & Performance Fixes — StackFix",
        ...
        (
            "netlify",
            "Netlify Security & Performance Fixes — StackFix",
        ...
        (
            "express",
            "Express.js Security Fixes — StackFix",
        ...
        (
            "nextjs",
            "Next.js Security Fixes — StackFix",
        ...
        (
            "django",
            "Django Security Fixes — StackFix",
        ...
        (
            "fastapi",
            "FastAPI Security Fixes — StackFix",
        ...
        (
            "wordpress",
            "WordPress Security & Performance Fixes — StackFix",
        ...
        (
            "cognito",
            "AWS Cognito OAuth Fixes — StackFix",
    ...
    for slug, title, description, content, tool_url, cta, canonical in PROV:
        ...
        graph.extend(
            breadcrumb_items_to_graph(
                [("StackFix", "/"), ("Providers", "/providers/"), (headline, "")]
            )
        )
        p = write_page(
            "providers",
            ...
            breadcrumb=bc_html([("StackFix", "/"), ("Providers", "/providers/"), (headline, None)]),
            h1=headline,
            content=content,
            tool_url=tool_url,
            tool_cta_text=cta,
    ...
    graph = [
        collection_ld("StackFix fix guides", "/fix/", "All stack-specific fix guides for headers, CORS, CSP, OAuth, cache, and PageSpeed."),
        *breadcrumb_items_to_graph([("StackFix", "/"), ("Fix guides", "")]),
    ]
    p = write_page(
        "fix",
        "index",
        title="Fix Guides — StackFix",
        description="Stack-specific fixes for security headers, CORS, CSP, OAuth, caching, and PageSpeed.",
        canonical="/fix/",
        nav_section="Fix",
        breadcrumb=bc_html([("StackFix", "/"), ("Fix guides", None)]),
        h1="Fix guides",
        content=f"<p>Browse fixes by category, then open the matching StackFix tool to validate your live deployment.</p><ul class='index-list'>{fix_links}</ul><p>Errors: <a href='/error/'>error hub</a>. Providers: <a href='/providers/'>provider hub</a>.</p>",
        tool_url="/headers/",
    ...
    err_links = "".join(
        f"<li><a href='{canonical}'>{title.replace(' — StackFix', '')}</a></li>" for _, title, _, _, _, _, canonical in ERR
    )
    graph = [
        collection_ld("StackFix error guides", "/error/", "Explain browser and OAuth errors with remediation paths."),
        *breadcrumb_items_to_graph([("StackFix", "/"), ("Errors", "")]),
    ]
    p = write_page(
        "error",
        "index",
        title="Error Guides — StackFix",
        description="CORS, CSP, OAuth, cache, and PageSpeed errors explained with fixes.",
        canonical="/error/",
        nav_section="Errors",
        breadcrumb=bc_html([("StackFix", "/"), ("Errors", None)]),
        h1="Error guides",
        content=f"<p>Each page describes the symptom, why it happens, and links to the StackFix tool that diagnoses it.</p><ul class='index-list'>{err_links}</ul>",
        tool_url="/cors/",
    ...
    prov_links = "".join(
        f"<li><a href='{canonical}'>{title.replace(' — StackFix', '')}</a></li>" for _, title, _, _, _, _, canonical in PROV
    )
    graph = [
        collection_ld("StackFix provider hubs", "/providers/", "All tools mapped to hosting and framework stacks."),
        *breadcrumb_items_to_graph([("StackFix", "/"), ("Providers", "")]),
    ]
    p = write_page(
        "providers",
        "index",
        title="Provider & Stack Hubs — StackFix",
        description="Nginx, Cloudflare, Vercel, frameworks, and identity providers on StackFix.",
        canonical="/providers/",
        nav_section="Providers",
        breadcrumb=bc_html([("StackFix", "/"), ("Providers", None)]),
    ...
    graph = [
        collection_ld("StackFix glossary", "/glossary/", "Glossary entries coming soon."),
        *breadcrumb_items_to_graph([("StackFix", "/"), ("Glossary", "")]),
    ]
    p = write_page(
        "glossary",
        "index",
        title="Glossary — StackFix",
        description="Security and performance glossary — entries coming soon.",
        canonical="/glossary/",
        nav_section="Glossary",
        breadcrumb=bc_html([("StackFix", "/"), ("Glossary", None)]),
        h1="Glossary",
    ...
    graph = [
        collection_ld("StackFix comparisons", "/vs/", "Tool comparisons — more articles coming soon."),
        *breadcrumb_items_to_graph([("StackFix", "/"), ("Comparisons", "")]),
    ]
    p = write_page(
        "vs",
        "index",
        title="Comparisons — StackFix",
        description="StackFix vs other tools — articles coming soon.",
        canonical="/vs/",
        nav_section="Vs",
        breadcrumb=bc_html([("StackFix", "/"), ("Comparisons", None)]),
        h1="Comparisons",
        content="<p>StackFix vs other scanners and checkers. Read <a href='/vs/stackfix-vs-securityheaders/'>StackFix vs securityheaders.com</a>. More matchups coming.</p>",
        tool_url="/headers/",
        tool_cta_text="Open HeadersFixer →",
        schema_graph=graph,
        flat=True,
    ...
    graph = [
        collection_ld("StackFix blog", "/blog/", "Articles on CSP enforcement, headers, and performance."),
        *breadcrumb_items_to_graph([("StackFix", "/"), ("Blog", "")]),
    ]
    p = write_page(
        "blog",
        "index",
        title="Blog — StackFix",
        description="StackFix articles on SharePoint CSP, security headers, and web performance.",
        canonical="/blog/",
        nav_section="Blog",
        breadcrumb=bc_html([("StackFix", "/"), ("Blog", None)]),
        h1="Blog",
    ...
    vs_canonical = "/vs/stackfix-vs-securityheaders/"
    vs_title = "StackFix vs securityheaders.com — Why Fixers Beat Checkers — StackFix"
    vs_desc = "securityheaders.com gives letter grades; StackFix generates copy-paste fixes for Nginx, Cloudflare, Vercel, and more."
    vs_content = (
        ...
        "| Price | Free | Free (MIT) |\n"
        "</div>"
        "<p>StackFix fills the gap between <em>knowing</em> you are missing HSTS and <em>shipping</em> the exact directive. Run HeadersFixer on your canonical URL, then deploy the recommended block and re-scan.</p>"
    ...
    graph = [
        article_ld(
            "StackFix vs securityheaders.com — Why Fixers Beat Checkers",
            vs_canonical,
            vs_desc,
        ),
        *breadcrumb_items_to_graph(
            [("StackFix", "/"), ("Comparisons", "/vs/"), ("vs securityheaders.com", "")]
        ),
    ]
    p = write_page(
        "vs",
        "stackfix-vs-securityheaders",
        title=vs_title,
        description=vs_desc,
        ...
        breadcrumb=bc_html(
            [
                ("StackFix", "/"),
                ("Comparisons", "/vs/"),
                ("StackFix vs securityheaders.com", None),
            ]
        ),
        h1="StackFix vs securityheaders.com — Why Fixers Beat Checkers",
        content=vs_content,
        tool_url="/headers/",
